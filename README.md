...
\_   _____/|   |/  _____/|  |   _____/  |_       |__| ______
 ...
 \___  /   |___|\______  /____/\___  >__| /\ /\__|  /____  >
     \/                \/          \/     \/ \______|    \/
```
巨大文字AAを生成するモジュール。フォントは多数ある。figletという名称は巨大文字AA生成ツールの共通名称であり、調べるとスタイルリストが出てくるが、実際に使えるのは[ここ](https://github.com/patorjk/figlet.js/tree/master/fonts)にあるものであることに注意。
